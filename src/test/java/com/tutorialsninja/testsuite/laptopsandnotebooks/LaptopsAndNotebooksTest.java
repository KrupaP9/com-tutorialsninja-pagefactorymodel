...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        checkoutPage.enterBillingDetailsFirstName("Priya");
        checkoutPage.enterBillingDetailsLastName("Patel");
        checkoutPage.enterBillingDetailsEmail("priyapatel@gmail.com");
        Thread.sleep(500);
        checkoutPage.enterBillingDetailsTelephone("45678645786");
        checkoutPage.enterBillingDetailsAddress("10 XYZ Road");
        checkoutPage.enterBillingDetailsCity("XYZ");
        checkoutPage.enterBillingDetailsPostcode("AB59CD");
        checkoutPage.enterBillingDetailsCountry("United States");
        Thread.sleep(500);
        checkoutPage.enterBillingDetailsRegionOrState("Arizona");
        //2.21 Click on “Continue” Button
        checkoutPage.clickOnContinueBillingButton();
        //2.22 Add Comments About your order into text area
        checkoutPage.enterComment("Comment About Order");
